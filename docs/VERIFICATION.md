...
| Unit/service/HTTP suite | 103 passed, 0 failed; 8 emulator tests intentionally skipped in this command |
...
| Full dependency audit | 0 known vulnerabilities reported by `npm audit` |
...
The normal suite and emulator suite are distinct; 103 + 8 = **111 passing tests across both runs**, not 111 tests in the normal command.
